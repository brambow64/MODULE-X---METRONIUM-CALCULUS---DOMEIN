...
This layer governs the entire system.
...
- **04-01-01** — Symbol Base  
  `AXIS + POSITION + STATE`
- **04-02** — Live Observation
- **04-03** — Circular Projection
...
### 05-VX — VISUAL EXPORT
Structural symbols may be expressed with volumetric orientation:

`◐ ◑ ◒ ◓`

### 06-EM — EMERGENT
Visible co-occurrence and overlay only.  
